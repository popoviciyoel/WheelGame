  ...
  window._gsDefine(
    ...
    function (t, e, i, r) {
      var s,
        ...
        _ = function (t, e, i, r) {
          for (var s, n, a = e.length, o = 0, l = h; --a > -1; )
            (s = e[a]),
              (n = s - t),
              0 > n && (n = -n),
              l > n && s >= r && i >= s && ((o = a), (l = n));
          ...
          var h,
            ...
            S =
              s.ease instanceof i
                ...
                ? new i(s.ease)
                : e.defaultEase,
            C = isNaN(k.checkpoint) ? 0.05 : Number(k.checkpoint),
            R = isNaN(k.resistance)
              ? l.defaultResistance
              : Number(k.resistance);
          for (h in k)
            "resistance" !== h &&
              ...
              "object" != typeof p &&
                ...
                x && x.isTrackingProp(h)
                  ...
                  : ((m = Number(p) || 0), (_ = m * R > 0 ? m / R : m / -R))),
              "object" == typeof p &&
                (void 0 !== p.velocity && "number" == typeof p.velocity
                  ? (m = Number(p.velocity) || 0)
                  : ((x = x || r.getByTarget(t)),
                    (m = x && x.isTrackingProp(h) ? x.getVelocity(h) : 0)),
                (g = isNaN(p.resistance) ? R : Number(p.resistance)),
                (_ = m * g > 0 ? m / g : m / -g),
                (v =
                  "function" == typeof t[h]
                    ? t[
                        h.indexOf("set") ||
                        "function" != typeof t["get" + h.substr(3)]
                          ? h
                          : "get" + h.substr(3)
                      ]()
                    : t[h] || 0),
                (y = v + c(m, S, _, C)),
                void 0 !== p.end && (p = f(p, y, p.max, p.min)),
                void 0 !== p.max && y > Number(p.max) + u
                  ? ((T = p.unitFactor || 1),
                    (w =
                      (v > p.max && p.min !== p.max) ||
                      (m * T > -15 && 45 > m * T)
      ...
      return (
        ...
        (l._cssRegister = function () {
          var t = (window.GreenSockGlobals || window).com.greensock.plugins
            .CSSPlugin;
          if (t) {
            var e = t._internals,
              i = e._parseToProxy,
            ...
            e._registerComplexSpecialProp("throwProps", {
              parser: function (t, e, h, u, _, f) {
                  ...
                  "resistance" !== m &&
                    ...
                    "object" == typeof d
                      ? (void 0 !== d.velocity && "number" == typeof d.velocity
                          ? (y[m] = Number(d.velocity) || 0)
                          : ((v = v || r.getByTarget(t)),
                            (y[m] =
                              v && v.isTrackingProp(m) ? v.getVelocity(m) : 0)),
                        void 0 !== d.end && (T[m] = d.end),
                        void 0 !== d.min && (w[m] = d.min),
                        void 0 !== d.max && (x[m] = d.max),
                        d.preventOvershoot && (P[m] = !0),
                        void 0 !== d.resistance &&
                          ((c = !0), (b[m] = d.resistance)))
                      : "number" == typeof d
                      ? (y[m] = d)
                      : ((v = v || r.getByTarget(t)),
                        (y[m] =
                          v && v.isTrackingProp(m)
                            ? v.getVelocity(m)
                            : d || 0)),
                    p[m] && u._enableTransforms(2 === p[m]));
                ...
                return (
                  ...
                  (_ = new o(t, "throwProps", 0, 0, g.pt, 2)),
                  (_.plugin = f),
                  (_.setRatio = a),
                  (_.data = g),
                  f._onInitTween(s, n, u._tween),
                  _
                );
              },
            });
            ...
            u.vars.css
              ? (u.duration(
                ...
                u._delay && !u.vars.immediateRender
                  ? u.invalidate()
                  : a._onInitTween(s, o, u),
                u)
              : (u.kill(), new e(t, m(t, i, r, l, h), i))
          );
        }),
        (g._onInitTween = function (t, e, i) {
          ...
          var s,
            ...
            m,
            g = i._ease,
            v = isNaN(e.checkpoint) ? 0.05 : Number(e.checkpoint),
            y = i._duration,
          ...
          for (s in e)
            if (
              ...
              if (((n = e[s]), "number" == typeof n)) u = Number(n) || 0;
                ...
                if (((m = m || r.getByTarget(t)), !m || !m.isTrackingProp(s)))
                  throw (
              ...
              (p = c(u, g, y, v)),
                ...
                "object" == typeof n &&
                  ((_ = l + p),
                  void 0 !== n.end && (n = f(n, _, n.max, n.min)),
                  void 0 !== n.max && _ > Number(n.max)
        ...
        var e,
              ...
              for (s = r, r = a; n; ) {
                for (i = n._firstVP; i; )
                  (t = i.css
                    ...
                    : n.target[i.p]),
                    (t !== i.v1 || a - i.t1 > 0.15) &&
                      ((i.v2 = i.v1), (i.v1 = t), (i.t2 = i.t1), (i.t1 = a)),
                    (i = i._next);
                n = n._next;
              }
          },
          f = function (t) {
            (this._lookup = {}),
              ...
              i ||
                (u.addEventListener("tick", _, null, !1, -100),
                (r = s = u.time),
                (i = !0)),
          ...
          (d.addProp = function (e, i) {
            if (!this._lookup[e]) {
              ...
              (this._firstVP =
                ...
                this._lookup[n] =
                a =
                  new p(n !== e && 0 === e.indexOf("set") ? n : e, s, a)),
                (a.css =
                  this.elem && (void 0 !== this.target.style[a.p] || o[a.p])),
                a.css &&
                  o[a.p] &&
                  !r._gsTransform &&
                  t.set(r, {
                ...
                (a.type =
                  i || (a.css && 0 === e.indexOf("rotation")) ? "deg" : ""),
                (a.v1 = a.v2 = a.css ? h(r, a.p) : s ? r[a.p]() : r[a.p]);
            }
          }),
