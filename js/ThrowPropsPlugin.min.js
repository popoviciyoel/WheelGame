...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    "use strict";
    window._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(t, e, i, r) {
        var s, n, a, o, l = function() {
            ...
            _ = function(t, e, i, r) {
                for (var s, n, a = e.length, o = 0, l = h; --a > -1;) s = e[a], n = s - t, 0 > n && (n = -n), l > n && s >= r && i >= s && (o = a, l = n);
                return e[o]
            },
            f = function(t, e, i, r) {
        ...
        return g.constructor = l, l.version = "0.9.2", l.source = "gannon.codecanyon", l.API = 2, l._autoCSS = !0, l.defaultResistance = 100, l.track = function(t, e, i) {
            ...
            if (t) {
                ...
                e._registerComplexSpecialProp("throwProps", {
                    parser: function(t, e, h, u, _, f) {
                        ...
                        g = i(t, y, u, _, f), s = g.proxy, y = g.end;
                        for (m in s) n[m] = {
                            velocity: y[m],
                            min: w[m],
                            max: x[m],
                        ...
                        return null != e.resistance && (n.resistance = e.resistance), e.preventOvershoot && (n.preventOvershoot = !0), _ = new o(t, "throwProps", 0, 0, g.pt, 2), _.plugin = f, _.setRatio = a, _.data = g, f._onInitTween(s, n, u._tween), _
                    }
                })
            }
            ...
            var u = new e(t, 1, i);
            return u.render(0, !0, !0), u.vars.css ? (u.duration(m(s, {
                throwProps: n,
                ease: i.ease
            }, r, l, h)), u._delay && !u.vars.immediateRender ? u.invalidate() : a._onInitTween(s, o, u), u) : (u.kill(), new e(t, m(t, i, r, l, h), i))
        }, g._onInitTween = function(t, e, i) {
            this.target = t, this._props = [], a = this, o = e;
            var s, n, l, h, u, p, _, d, m, g = i._ease,
            ...
            for (s in e)
                if ("resistance" !== s && "checkpoint" !== s && "preventOvershoot" !== s) {
                    if (n = e[s], "number" == typeof n) u = Number(n) || 0;
                        ...
                        if (m = m || r.getByTarget(t), !m || !m.isTrackingProp(s)) throw "ERROR: No velocity was defined in the throwProps tween of " + t + " property: " + s;
                        u = m.getVelocity(s)
                    } else u = Number(n.velocity);
                    p = c(u, g, y, v), d = 0, h = "function" == typeof t[s], l = h ? t[s.indexOf("set") || "function" != typeof t["get" + s.substr(3)] ? s : "get" + s.substr(3)]() : t[s], "object" == typeof n && (_ = l + p, void 0 !== n.end && (n = f(n, _, n.max, n.min)), void 0 !== n.max && _ > Number(n.max) ? w || n.preventOvershoot ? p = n.max - l : d = n.max - l - p : void 0 !== n.min && Number(n.min) > _ && (w || n.preventOvershoot ? p = n.min - l : d = n.min - l - p)), this._props[x++] = {
                        p: s,
                        s: l,
                        c1: p,
                        c2: d,
            ...
            for (var e, i, r = this._props.length; --r > -1;) e = this._props[r], i = e.s + e.c1 * t + e.c2 * t * t, e.r && (i = 0 | i + (i > 0 ? .5 : -.5)), e.f ? this.target[e.p](i) : this.target[e.p] = i
        }, t.activate([l]), l
        ...
        var e, i, r, s, n = /([A-Z])/g,
            ...
            h = function(t, e, i) {
                var r = (t._gsTransform || a)[e];
                return r || 0 === r ? r : (t.style[e] ? r = t.style[e] : (i = i || l(t, null)) ? (t = i.getPropertyValue(e.replace(n, "-$1").toLowerCase()), r = t || i.length ? t : i[e]) : t.currentStyle && (i = t.currentStyle, r = i[e]), parseFloat(r) || 0)
            },
            u = t.ticker,
            p = function(t, e, i) {
            ...
            f = function(t) {
                this._lookup = {}, this.target = t, this.elem = t.style && t.nodeType ? !0 : !1, i || (u.addEventListener("tick", _, null, !1, -100), r = s = u.time, i = !0), e && (this._next = e, e._prev = this), e = this
            },
            c = f.getByTarget = function(t) {
                for (var i = e; i;) {
        ...
        return d.addProp = function(e, i) {
            if (!this._lookup[e]) {
                var r = this.target,
                    ...
                    a = this._firstVP;
                this._firstVP = this._lookup[e] = this._lookup[n] = a = new p(n !== e && 0 === e.indexOf("set") ? n : e, s, a), a.css = this.elem && (void 0 !== this.target.style[a.p] || o[a.p]), a.css && o[a.p] && !r._gsTransform && t.set(r, {
                    x: "+=0"
                }), a.type = i || a.css && 0 === e.indexOf("rotation") ? "deg" : "", a.v1 = a.v2 = a.css ? h(r, a.p) : s ? r[a.p]() : r[a.p]
            }
            ...
            var r = c(t),
                s = e.split(","),
                n = s.length;
            for (i = (i || "").split(","), r || (r = new f(t)); --n > -1;) r.addProp(s[n], i[n] || i[0]);
            return r
