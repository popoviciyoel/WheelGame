function Spin2WinWheel() {
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    wheelFrameSVG = select(".wheelFrameSVG"),
    wheel = select(".wheel"),
    ...
    spinVelocityTracker,
    gameResultsArray = [],
    pegSnd = new Audio("../media/images/wheel_tick.mp3"),
    ...
    requiredProb,
    initError1 = "Invalid destination ",
    //initError1 = "Invalid destination set - please ensure the destination in spinDestinationArray is greater than 0 and less than or equal to the number of segments",
    //initError2 = "Not enough segments. Please add more entries to segmentValuesArray",
    initError2 = "Not enough segments",
    probabilityErrorStr =
    ...
    drawSegments = function () {
      ...
      for (var i = 0; i < numSegments; i++) {
        ...
        var wheelColors = params2.get("wheelColors");

        //check if there are enough colors in the array to support the numer of segments
        if (colorArray[i]) {
          if (wheelColors) {
            const wheelColorsArray = wheelColors.split(",");
            const newWheelColors = [
              ...wheelColorsArray,
              ...wheelColorsArray,
              ...wheelColorsArray,
            ];
            destFill = `${newWheelColors[i]}`;
          } else {
      ...
      addValues(
        prize1Img && prize1Img.length > 0 ? prize1Img.split(",") : temp
      );
    },
    ...
    addValues = function (prize) {
      for (var i = 0; i < numSegments; i++) {
        ...
        if (segmentValuesArray[i].type == "image") {
          ...
          ig.setAttributeNS(null, "x", centerX - 20 - wheelImageSize / 2); //@wiply -30 to location x
          ig.setAttributeNS(
            null,
            "y",
            centerY - wheelRadius + wheelImageOffsetY + 35
          );
          ig.setAttributeNS(null, "width", wheelImageSize + 40); // @wiply add 50 to prize
          ig.setAttributeNS(null, "height", wheelImageSize + 40);
          //@Wiply
    ...
    throwComplete = function () {
      ...
      if (
        spinVelocityTracker &&
        Math.abs(spinVelocityTracker.getVelocity("rotation")) <=
          invalidSpinThreshold
      ) {
        enableWheel();
  ...
  (createProbabilityArray = function () {
    ...
    //   // toast.style.index = 2;
    //   toast.style.backgroundColor = "#231F20";
    //   //       var modalStr = '<p class="toast-title">'+
    //   // "זכית!!"+
    //   //        "</p >"+
    //   //        str
  ...
  this.init = function (e) {
    ...
    wheelSVG.setAttribute(
      "viewBox",
      "0 0 " + svgWidth + " " + e.data.svgHeight
    );
    wheelFrameSVG.setAttribute(
      "viewBox",
      "40 0 " + svgWidth + " " + e.data.svgHeight
    );
    dataObj = e.data;
